...
var AutenticacionController = /** @class */ (function () {
    ...
    AutenticacionController.prototype.autenticarUsuario = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var autenticacionService, responseAutenticarUsuario;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        autenticacionService = new autenticacion_services_1.default();
                        return [4 /*yield*/, autenticacionService.autenticarUsuario(req, res)];
                    case 1:
                        responseAutenticarUsuario = _a.sent();
                        // Devuelve el response de autenticacion de usuarios
                        return [2 /*return*/, responseAutenticarUsuario];
                }
            });
        });
    };
