...
var BannersService = /** @class */ (function () {
     ...
     * @param res
     */
    BannersService.prototype.getBanners = function (res) {
        return __awaiter(this, void 0, void 0, function () {
            var logServer, logger, connection, database, quotesCollection, banners;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        quotesCollection = database.collection(enviroment_1.COLLECTIONS.banners);
                    ...
                    case 2:
                        ...
                        try {
                            ...
                            if (banners) {
                                res.status(200).send({ status: 'OK', banners: banners });
                            }
                            else {
...
exports.default = BannersService;
